...
var getGroup = function getGroup(item, ui) {
  return item.isBeingEdited ? _react2.default.createElement(_itemInputGroups.ModifyItemInputGroup, { item: item }) : _react2.default.createElement(_viewItemGroup2.default, {
    item: item,
    ui: ui
  });
};
...
Item.defaultProps = ListItem.defaultProps = _proptypes.itemUiDefaultProps;
