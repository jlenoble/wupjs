...
var NameSelectionInputGroup = makeItemInputGroup({
  ...
  makeHandleSubmit: function makeHandleSubmit() {
    return function (input, clearInput, dispatch) {
      ...
      dispatch((0, _actions.newItem)(input.value)).then(function (item) {
        return dispatch((0, _actions.displaySelectionName)(item));
      }, function () {
        return dispatch((0, _actions.stopNamingSelection)());
      }).then(function (_ref3) {
        var item = _ref3.item;
        return dispatch((0, _actions.newSelection)(item));
      });
      clearInput();
    };
  }
