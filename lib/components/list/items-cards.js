...
var CurrentSelectionCard = makeCard({
  ...
  mapStateToProps: function mapStateToProps(state) {
    ...
    var _state$currentItem = state.currentItem,
        ...
        cardName = _state$currentItem.cardName;
    ...
    props.items = Object.keys(items).filter(function (key) {
      ...
      return Object.assign({
        isBeingEdited: isBeingEdited && key === _id && CurrentSelectionCard.name === cardName,
        isSelected: true,
...
var AllItemsCard = makeCard({
  ...
  mapStateToProps: function mapStateToProps(state) {
    ...
    var _state$currentItem2 = state.currentItem,
        _id = _state$currentItem2._id,
        isBeingEdited = _state$currentItem2.isBeingEdited,
        cardName = _state$currentItem2.cardName;
    ...
    props.items = Object.keys(items).map(function (key) {
      var item = items[key];
      return Object.assign({
        isBeingEdited: isBeingEdited && item._id === _id && AllItemsCard.name === cardName,
