...
var _fetchSelections = require('./fetch-selections');

Object.keys(_fetchSelections).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _fetchSelections[key];
    }
  });
});

var _newSelection = require('./new-selection');

Object.keys(_newSelection).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _newSelection[key];
    }
  });
});